...
def run(
    ...
    record_filename = f"./record_sim/record_coherent_XX_d{code_distance}_r{num_round}_i{initial_state}.json"
    ...
    for noise_property in noise_model.noise_property_list:
        ...
        sample_noise_property.noise_type = NoiseType.COHERENT_XX_ERROR
