...
def run(
    ...
    record_filename = f"./record_sim/record_depolarizing_d{code_distance}_r{num_round}_i{initial_state}.json"
    ...
    dataset = sample_records_with_qulacs(circuit, num_shot, noise_model)
